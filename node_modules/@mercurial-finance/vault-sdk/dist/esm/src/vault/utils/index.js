...
export const unwrapSOLInstruction = (walletPublicKey) => __awaiter(void 0, void 0, void 0, function* () {
    const wSolATAAccount = yield Token.getAssociatedTokenAddress(ASSOCIATED_TOKEN_PROGRAM_ID, TOKEN_PROGRAM_ID, NATIVE_MINT, walletPublicKey, true);
    if (wSolATAAccount) {
...
export function chunkedFetchMultipleVaultAccount(program, pks, chunkSize = 100) {
