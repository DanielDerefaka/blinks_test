...
import { chunkedFetchMultipleVaultAccount, chunkedGetMultipleAccountInfos, deserializeAccount, getAssociatedTokenAccount, getLpSupply, getOnchainTime, getOrCreateATAInstruction, getVaultPdas, unwrapSOLInstruction, wrapSOLInstruction, } from './utils';
...
const getAllVaultState = (tokenInfos, program, seedBaseKey) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const vaultsState = (yield chunkedFetchMultipleVaultAccount(program, vaultPdas));
    ...
    const vaultLpAccounts = yield chunkedGetMultipleAccountInfos(program.provider.connection, vaultLpMints);
...
const getAllVaultStateByPda = (tokensInfoPda, program) => __awaiter(void 0, void 0, void 0, function* () {
...
const getVaultStateByPda = (tokenInfoPda, program) => __awaiter(void 0, void 0, void 0, function* () {
    const vaultState = (yield program.account.vault.fetchNullable(tokenInfoPda.vaultPda));
    if (!vaultState) {
        throw 'Cannot get vault state';
    }
    const lpSupply = yield getLpSupply(program.provider.connection, tokenInfoPda.lpMintPda);
    return Object.assign(Object.assign({}, tokenInfoPda), { vaultState, lpSupply });
});
...
export default class VaultImpl {
    ...
    static createMultiple(connection, tokenInfos, opt) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return vaultsStateInfo.map(({ vaultPda, tokenVaultPda, lpMintPda, vaultState, lpSupply }, index) => {
                ...
                return new VaultImpl(program, { tokenInfo, vaultPda, tokenVaultPda, vaultState, lpSupply, lpMintPda }, Object.assign(Object.assign({}, opt), { affiliateId: opt === null || opt === void 0 ? void 0 : opt.affiliateId, affiliateProgram: (opt === null || opt === void 0 ? void 0 : opt.affiliateId)
                        ? new Program(AffiliateIDL, (opt === null || opt === void 0 ? void 0 : opt.affiliateProgramId) || AFFILIATE_PROGRAM_ID, provider)
                        : undefined }));
            });
        });
    }
    static createMultipleWithPda(connection, tokensInfoPda, opt) {
        return __awaiter(this, void 0, void 0, function* () {
            const provider = new AnchorProvider(connection, {}, AnchorProvider.defaultOptions());
            const program = new Program(IDL, (opt === null || opt === void 0 ? void 0 : opt.programId) || PROGRAM_ID, provider);
            const vaultsStateInfo = yield getAllVaultStateByPda(tokensInfoPda, program);
            return vaultsStateInfo.map(({ vaultPda, tokenVaultPda, lpMintPda, vaultState, lpSupply }, index) => {
    ...
    static create(connection, tokenInfo, opt) {
        return __awaiter(this, void 0, void 0, function* () {
            const provider = new AnchorProvider(connection, {}, AnchorProvider.defaultOptions());
            const program = new Program(IDL, (opt === null || opt === void 0 ? void 0 : opt.programId) || PROGRAM_ID, provider);
            const { vaultPda, tokenVaultPda, lpMintPda, vaultState, lpSupply } = yield getVaultState(tokenInfo, program);
            return new VaultImpl(program, { tokenInfo, vaultPda, tokenVaultPda, vaultState, lpSupply, lpMintPda }, Object.assign(Object.assign({}, opt), { affiliateId: opt === null || opt === void 0 ? void 0 : opt.affiliateId, affiliateProgram: (opt === null || opt === void 0 ? void 0 : opt.affiliateId)
                    ? new Program(AffiliateIDL, (opt === null || opt === void 0 ? void 0 : opt.affiliateProgramId) || AFFILIATE_PROGRAM_ID, provider)
                    : undefined }));
        });
    ...
    refreshVaultState() {
        return __awaiter(this, void 0, void 0, function* () {
            const { vaultState, lpSupply } = yield getVaultStateByPda({ info: this.tokenInfo, lpMintPda: this.lpMintPda, tokenVaultPda: this.tokenVaultPda, vaultPda: this.vaultPda }, this.program);
    ...
    createAffiliateATAPreInstructions(owner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [partnerAddress, _nonce] = PublicKey.findProgramAddressSync([this.vaultPda.toBuffer(), partnerToken.toBuffer()], this.affiliateProgram.programId);
            const [userAddress, _nonceUser] = PublicKey.findProgramAddressSync([partnerAddress.toBuffer(), owner.toBuffer()], this.affiliateProgram.programId);
            let preInstructions = [];
            const [userToken, createUserTokenIx] = yield getOrCreateATAInstruction(new PublicKey(this.tokenInfo.address), owner, this.connection);
