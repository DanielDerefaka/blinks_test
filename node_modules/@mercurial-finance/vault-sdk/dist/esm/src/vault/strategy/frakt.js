...
export default class FraktHandler {
    ...
    withdraw(walletPubKey, program, strategy, vault, tokenVault, vaultState, userToken, userLp, amount, preInstructions, postInstructions, opt) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [liqOwner] = PublicKey.findProgramAddressSync([Buffer.from(SEEDS.FRAKT_LENDING), strategy.state.reserve.toBuffer()], FRAKT_PROGRAM_ID);
            ...
            const [strategyOwner] = PublicKey.findProgramAddressSync([Buffer.from(SEEDS.FRAKT), strategyBuffer], program.programId);
            ...
            const [deposit] = PublicKey.findProgramAddressSync([Buffer.from(SEEDS.DEPOSIT), strategyReserveBuffer, new PublicKey(strategyOwner).toBuffer()], FRAKT_PROGRAM_ID);
            const accounts = [
