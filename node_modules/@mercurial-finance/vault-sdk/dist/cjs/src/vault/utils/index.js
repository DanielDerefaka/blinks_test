...
exports.chunkedGetMultipleAccountInfos = exports.chunkedFetchMultipleVaultAccount = exports.chunks = exports.getLpSupply = exports.getOnchainTime = exports.unwrapSOLInstruction = exports.wrapSOLInstruction = exports.getVaultPdas = exports.getOrCreateATAInstruction = exports.deserializeAccount = exports.getAssociatedTokenAccount = void 0;
...
const unwrapSOLInstruction = (walletPublicKey) => __awaiter(void 0, void 0, void 0, function* () {
    const wSolATAAccount = yield spl_token_1.Token.getAssociatedTokenAddress(spl_token_1.ASSOCIATED_TOKEN_PROGRAM_ID, spl_token_1.TOKEN_PROGRAM_ID, spl_token_1.NATIVE_MINT, walletPublicKey, true);
    if (wSolATAAccount) {
...
function chunkedFetchMultipleVaultAccount(program, pks, chunkSize = 100) {
