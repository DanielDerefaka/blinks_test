...
const getAllVaultState = (tokenInfos, program, seedBaseKey) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const vaultsState = (yield (0, utils_1.chunkedFetchMultipleVaultAccount)(program, vaultPdas));
    ...
    const vaultLpAccounts = yield (0, utils_1.chunkedGetMultipleAccountInfos)(program.provider.connection, vaultLpMints);
...
const getVaultStateByPda = (tokenInfoPda, program) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const lpSupply = yield (0, utils_1.getLpSupply)(program.provider.connection, tokenInfoPda.lpMintPda);
...
class VaultImpl {
    ...
    deposit(owner, baseTokenAmount) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.tokenInfo.address === spl_token_1.NATIVE_MINT.toString()) {
