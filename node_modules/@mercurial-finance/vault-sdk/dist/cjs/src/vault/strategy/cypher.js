...
class CypherHandler {
    ...
    withdraw(walletPubKey, program, strategy, vault, tokenVault, vaultState, userToken, userLp, amount, preInstructions, postInstructions, opt) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [strategyOwnerPubkey] = web3_js_1.PublicKey.findProgramAddressSync([Buffer.from(constants_1.SEEDS.CYPHER), strategyBuffer], program.programId);
