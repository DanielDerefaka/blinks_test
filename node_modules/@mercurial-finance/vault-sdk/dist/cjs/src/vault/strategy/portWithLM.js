...
class PortWithLMHandler {
    ...
    withdraw(walletPubKey, program, strategy, vault, tokenVault, vaultState, userToken, userLp, amount, preInstructions, postInstructions, opt) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let [collateralVault] = web3_js_1.PublicKey.findProgramAddressSync([Buffer.from(constants_1.SEEDS.COLLATERAL_VAULT_PREFIX), strategyBuffer], program.programId);
            const rewarder = new web3_js_1.PublicKey(constants_1.REWARDER);
            const [quarryPda] = web3_js_1.PublicKey.findProgramAddressSync([Buffer.from(constants_1.SEEDS.QUARRY), rewarder.toBuffer(), portCollateral.mintPubkey.toBuffer()], quarry.QUARRY_ADDRESSES.Mine);
            const [miner] = web3_js_1.PublicKey.findProgramAddressSync([Buffer.from(constants_1.SEEDS.MINER), quarryPda.toBuffer(), new web3_js_1.PublicKey(vault).toBuffer()], quarry.QUARRY_ADDRESSES.Mine);
            ...
            const [lendingMarketAuthority] = web3_js_1.PublicKey.findProgramAddressSync([lendingMarket.toBuffer()], this.strategyProgram);
            const accountData = [
