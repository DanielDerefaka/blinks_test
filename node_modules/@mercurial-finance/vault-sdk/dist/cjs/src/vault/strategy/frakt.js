...
class FraktHandler {
    ...
    withdraw(walletPubKey, program, strategy, vault, tokenVault, vaultState, userToken, userLp, amount, preInstructions, postInstructions, opt) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [liqOwner] = web3_js_1.PublicKey.findProgramAddressSync([Buffer.from(constants_1.SEEDS.FRAKT_LENDING), strategy.state.reserve.toBuffer()], FRAKT_PROGRAM_ID);
            ...
            const [strategyOwner] = web3_js_1.PublicKey.findProgramAddressSync([Buffer.from(constants_1.SEEDS.FRAKT), strategyBuffer], program.programId);
            ...
            const [deposit] = web3_js_1.PublicKey.findProgramAddressSync([Buffer.from(constants_1.SEEDS.DEPOSIT), strategyReserveBuffer, new web3_js_1.PublicKey(strategyOwner).toBuffer()], FRAKT_PROGRAM_ID);
            const accounts = [
