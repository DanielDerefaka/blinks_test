...
import { AmmImplementation, DepositQuote, LockEscrow, LockEscrowAccount, PoolInformation, PoolState, WithdrawQuote } from './types';
export default class AmmImpl implements AmmImplementation {
    ...
    private opt;
    private constructor();
    static createConfig(connection: Connection, payer: PublicKey, tradeFeeBps: BN, protocolFeeBps: BN, vaultConfigKey: PublicKey, activationDurationInSlot: BN, opt?: {
        cluster?: Cluster;
        programId?: string;
    }): Promise<Transaction>;
    static createPermissionlessConstantProductPoolWithConfig(connection: Connection, payer: PublicKey, tokenInfoA: TokenInfo, tokenInfoB: TokenInfo, tokenAAmount: BN, tokenBAmount: BN, config: PublicKey, opt?: {
        cluster?: Cluster;
        programId?: string;
    ...
    static getLockedLpAmountByUser(connection: Connection, userPubKey: PublicKey, opt?: {
        programId?: string;
        cluster?: Cluster;
    }): Promise<Map<string, import("@project-serum/anchor/dist/cjs/program/namespace/types").TypeDef<{
        name: "lockEscrow";
    ...
    lockLiquidity(owner: PublicKey, amount: BN): Promise<Transaction>;
