...
const getAllPoolState = (poolMints, program) => __awaiter(void 0, void 0, void 0, function* () {
    const poolStates = (yield (0, utils_1.chunkedFetchMultiplePoolAccount)(program, poolMints));
    ...
    const lpMintAccounts = yield (0, utils_1.chunkedGetMultipleAccountInfos)(program.provider.connection, poolLpMints);
...
class AmmImpl {
    constructor(address, program, vaultProgram, tokenInfos, poolState, poolInfo, vaultA, vaultB, accountsInfo, swapCurve, depegAccounts, opt) {
    ...
    static createConfig(connection, payer, tradeFeeBps, protocolFeeBps, vaultConfigKey, activationDurationInSlot, opt) {
        return __awaiter(this, void 0, void 0, function* () {
            const { ammProgram } = (0, utils_1.createProgram)(connection, opt === null || opt === void 0 ? void 0 : opt.programId);
            ...
            while (true) {
                ...
                if (!configs.find((c) => c.publicKey.equals(configPda))) {
                    const createConfigTx = yield ammProgram.methods
                        ...
                        .transaction();
                    return new web3_js_1.Transaction(Object.assign({ feePayer: payer }, (yield ammProgram.provider.connection.getLatestBlockhash(ammProgram.provider.connection.commitment)))).add(createConfigTx);
                }
                else {
                    index++;
                }
    ...
    static createPermissionlessConstantProductPoolWithConfig(connection, payer, tokenInfoA, tokenInfoB, tokenAAmount, tokenBAmount, config, opt) {
        return __awaiter(this, void 0, void 0, function* () {
            const { vaultProgram, ammProgram } = (0, utils_1.createProgram)(connection, opt === null || opt === void 0 ? void 0 : opt.programId);
            let tokenAMint = new web3_js_1.PublicKey(tokenInfoA.address);
            let tokenBMint = new web3_js_1.PublicKey(tokenInfoB.address);
            ...
            if (preInstructions.length) {
                const preInstructionTx = new web3_js_1.Transaction(Object.assign({ feePayer: payer }, (yield ammProgram.provider.connection.getLatestBlockhash(ammProgram.provider.connection.commitment)))).add(...preInstructions);
                resultTx.push(preInstructionTx);
            }
            const setComputeUnitLimitIx = web3_js_1.ComputeBudgetProgram.setComputeUnitLimit({
                units: 1400000,
            });
            const mainTx = new web3_js_1.Transaction(Object.assign({ feePayer: payer }, (yield ammProgram.provider.connection.getLatestBlockhash(ammProgram.provider.connection.commitment))))
            ...
            if (opt === null || opt === void 0 ? void 0 : opt.lockLiquidity) {
                ...
                const [escrowAta, createEscrowAtaIx] = yield (0, utils_1.getOrCreateATAInstruction)(lpMint, lockEscrowPK, connection, payer);
    ...
    static createPermissionlessPool(connection, payer, tokenInfoA, tokenInfoB, tokenAAmount, tokenBAmount, isStable, tradeFeeBps, opt) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const createPermissionlessPoolTx = yield ammProgram.methods
                ...
                .transaction();
            return new web3_js_1.Transaction(Object.assign({ feePayer: payer }, (yield ammProgram.provider.connection.getLatestBlockhash(ammProgram.provider.connection.commitment)))).add(createPermissionlessPoolTx);
        });
    }
    static createMultiple(connection, poolList, opt) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const tokensInfoPda = poolList.reduce((accList, { tokenInfoA, tokenInfoB }, index) => {
            ...
            const vaultsImpl = yield vault_sdk_1.default.createMultipleWithPda(connection, tokensInfoPda);
            ...
            const ammImpls = yield Promise.all(accountsToFetch.map((accounts) => __awaiter(this, void 0, void 0, function* () {
                ...
                return new AmmImpl(pool, ammProgram, vaultProgram, [vaultA.tokenInfo, vaultB.tokenInfo], poolState, poolInfo, vaultA, vaultB, accountsInfo, swapCurve, depegAccounts, {
                    cluster,
                });
            })));
            return ammImpls;
    ...
    static create(connection, pool, tokenInfoA, tokenInfoB, opt) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const poolInfo = (0, utils_1.calculatePoolInfo)(currentTime, poolVaultALp, poolVaultBLp, vaultALpSupply, vaultBLpSupply, poolLpSupply, swapCurve, vaultA.vaultState, vaultB.vaultState);
            return new AmmImpl(pool, ammProgram, vaultProgram, [tokenInfoA, tokenInfoB], poolState, poolInfo, vaultA, vaultB, accountsInfo, swapCurve, depegAccounts, {
                cluster,
            });
        });
    }
    ...
    getLockedAtaAmount() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const poolLpAta = yield (0, utils_1.getAssociatedTokenAccount)(this.poolState.lpMint, this.address);
    ...
    updateState() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.depegAccounts = yield (0, utils_1.getDepegAccounts)(this.program.provider.connection, [poolState]);
            if ('stable' in poolState.curveType) {
                const { amp, depeg, tokenMultiplier } = poolState.curveType['stable'];
    ...
    getUserBalance(owner) {
        return __awaiter(this, void 0, void 0, function* () {
            const account = yield (0, utils_1.getAssociatedTokenAccount)(this.poolState.lpMint, owner);
            if (!account)
                return new anchor_1.BN(0);
    ...
    swap(owner, inTokenMint, inAmountLamport, outAmountLamport, referralOwner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const protocolTokenFee = this.tokenA.address === inTokenMint.toBase58()
            ...
            if (referralOwner) {
                const [referralTokenAccount, createReferralTokenAccountIx] = yield (0, utils_1.getOrCreateATAInstruction)(inTokenMint, referralOwner, this.program.provider.connection, owner);
            ...
            const swapTx = yield this.program.methods
                ...
                .transaction();
            return new web3_js_1.Transaction(Object.assign({ feePayer: owner }, (yield this.program.provider.connection.getLatestBlockhash(this.program.provider.connection.commitment)))).add(swapTx);
        });
    }
    /**
    ...
    deposit(owner, tokenAInAmount, tokenBInAmount, poolTokenAmount) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (spl_token_1.NATIVE_MINT.equals(new web3_js_1.PublicKey(this.tokenA.address))) {
                preInstructions = preInstructions.concat((0, utils_1.wrapSOLInstruction)(owner, userAToken, BigInt(tokenAInAmount.toString())));
            }
            if (spl_token_1.NATIVE_MINT.equals(new web3_js_1.PublicKey(this.tokenB.address))) {
                preInstructions = preInstructions.concat((0, utils_1.wrapSOLInstruction)(owner, userBToken, BigInt(tokenBInAmount.toString())));
            }
            const postInstructions = [];
            if ([this.tokenA.address, this.tokenB.address].includes(spl_token_1.NATIVE_MINT.toBase58())) {
            ...
            const depositTx = yield programMethod()
                ...
                .postInstructions(postInstructions)
                .transaction();
            return new web3_js_1.Transaction(Object.assign({ feePayer: owner }, (yield this.program.provider.connection.getLatestBlockhash(this.program.provider.connection.commitment)))).add(depositTx);
        });
    }
    /**
    ...
    withdraw(owner, lpTokenAmount, tokenAOutAmount, tokenBOutAmount) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const withdrawTx = yield programMethod
                ...
                .postInstructions(postInstructions)
                .transaction();
            return new web3_js_1.Transaction(Object.assign({ feePayer: owner }, (yield this.program.provider.connection.getLatestBlockhash(this.program.provider.connection.commitment)))).add(withdrawTx);
        });
    }
    getUserLockEscrow(owner, lockEscrowAccount) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    lockLiquidity(owner, amount) {
        return __awaiter(this, void 0, void 0, function* () {
            const [lockEscrowPK] = (0, utils_1.deriveLockEscrowPda)(this.address, owner, this.program.programId);
            const preInstructions = [];
            const lockEscrowAccount = yield this.program.account.lockEscrow.fetch(lockEscrowPK);
            const lockEscrow = yield this.getUserLockEscrow(owner, lockEscrowAccount);
            if (!lockEscrow) {
            ...
            const [[userAta, createUserAtaIx], [escrowAta, createEscrowAtaIx]] = yield Promise.all([
                (0, utils_1.getOrCreateATAInstruction)(this.poolState.lpMint, owner, this.program.provider.connection, owner),
                (0, utils_1.getOrCreateATAInstruction)(this.poolState.lpMint, lockEscrowPK, this.program.provider.connection, owner),
            ]);
            ...
            const lockTx = yield this.program.methods
                ...
                .preInstructions(preInstructions)
                .transaction();
            return new web3_js_1.Transaction(Object.assign({ feePayer: owner }, (yield this.program.provider.connection.getLatestBlockhash(this.program.provider.connection.commitment)))).add(lockTx);
        });
    }
    claimLockFee(owner, maxAmount) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const tx = yield this.program.methods
                ...
                .postInstructions(postInstructions)
                .transaction();
            return new web3_js_1.Transaction(Object.assign({ feePayer: owner }, (yield this.program.provider.connection.getLatestBlockhash(this.program.provider.connection.commitment)))).add(tx);
        });
    }
