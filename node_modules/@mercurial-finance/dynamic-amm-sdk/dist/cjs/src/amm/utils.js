...
const getAssociatedTokenAccount = (tokenMint, owner) => __awaiter(void 0, void 0, void 0, function* () {
    return yield spl_token_1.Token.getAssociatedTokenAddress(spl_token_1.ASSOCIATED_TOKEN_PROGRAM_ID, spl_token_1.TOKEN_PROGRAM_ID, tokenMint, owner, true);
});
exports.getAssociatedTokenAccount = getAssociatedTokenAccount;
const getOrCreateATAInstruction = (tokenMint, owner, connection, payer) => __awaiter(void 0, void 0, void 0, function* () {
    let toAccount;
    try {
        toAccount = yield (0, exports.getAssociatedTokenAccount)(tokenMint, owner);
        const account = yield connection.getAccountInfo(toAccount);
        if (!account) {
            const ix = spl_token_1.Token.createAssociatedTokenAccountInstruction(spl_token_1.ASSOCIATED_TOKEN_PROGRAM_ID, spl_token_1.TOKEN_PROGRAM_ID, tokenMint, toAccount, owner, payer || owner);
            return [toAccount, ix];
        }
...
const unwrapSOLInstruction = (owner) => __awaiter(void 0, void 0, void 0, function* () {
    const wSolATAAccount = yield (0, exports.getAssociatedTokenAccount)(spl_token_1.NATIVE_MINT, owner);
    if (wSolATAAccount) {
 ...
 */
const getDepegAccounts = (connection, poolsState) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
function checkPoolExists(connection, tokenInfoA, tokenInfoB, isStable, tradeFeeBps, opt) {
    return __awaiter(this, void 0, void 0, function* () {
        const { ammProgram } = (0, exports.createProgram)(connection, opt === null || opt === void 0 ? void 0 : opt.programId);
 ...
 */
function checkPoolWithConfigExists(connection, tokenA, tokenB, config, opt) {
    return __awaiter(this, void 0, void 0, function* () {
        const { ammProgram } = (0, exports.createProgram)(connection, opt === null || opt === void 0 ? void 0 : opt.programId);
...
exports.checkPoolWithConfigExists = checkPoolWithConfigExists;
function chunks(array, size) {
    return Array.apply(0, new Array(Math.ceil(array.length / size))).map((_, index) => array.slice(index * size, (index + 1) * size));
}
exports.chunks = chunks;
function chunkedFetchMultiplePoolAccount(program, pks, chunkSize = 100) {
    return __awaiter(this, void 0, void 0, function* () {
