...
export declare const getAssociatedTokenAccount: (tokenMint: PublicKey, owner: PublicKey) => Promise<PublicKey>;
 ...
 */
export declare function checkPoolWithConfigExists(connection: Connection, tokenA: PublicKey, tokenB: PublicKey, config: PublicKey, opt?: {
    programId: string;
}): Promise<PublicKey | undefined>;
export declare function chunks<T>(array: T[], size: number): T[][];
export declare function chunkedFetchMultiplePoolAccount(program: AmmProgram, pks: PublicKey[], chunkSize?: number): Promise<(Object | null)[]>;
