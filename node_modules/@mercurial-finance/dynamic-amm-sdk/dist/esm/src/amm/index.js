...
import { AccountLayout, ASSOCIATED_TOKEN_PROGRAM_ID, MintLayout, NATIVE_MINT, TOKEN_PROGRAM_ID, u64, } from '@solana/spl-token';
...
export default class AmmImpl {
    ...
    static createMultiple(connection, poolList, opt) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const vaultsImpl = yield VaultImpl.createMultipleWithPda(connection, tokensInfoPda);
    ...
    lockLiquidity(owner, amount) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lockTx = yield this.program.methods
                ...
                .preInstructions(preInstructions)
                .transaction();
            return new Transaction(Object.assign({ feePayer: owner }, (yield this.program.provider.connection.getLatestBlockhash(this.program.provider.connection.commitment)))).add(lockTx);
        });
    }
