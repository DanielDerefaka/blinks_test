...
import { ASSOCIATED_TOKEN_PROGRAM_ID, Token, TOKEN_PROGRAM_ID, AccountLayout, u64, NATIVE_MINT, } from '@solana/spl-token';
...
export const getAssociatedTokenAccount = (tokenMint, owner) => __awaiter(void 0, void 0, void 0, function* () {
    return yield Token.getAssociatedTokenAddress(ASSOCIATED_TOKEN_PROGRAM_ID, TOKEN_PROGRAM_ID, tokenMint, owner, true);
});
export const getOrCreateATAInstruction = (tokenMint, owner, connection, payer) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!account) {
            const ix = Token.createAssociatedTokenAccountInstruction(ASSOCIATED_TOKEN_PROGRAM_ID, TOKEN_PROGRAM_ID, tokenMint, toAccount, owner, payer || owner);
            return [toAccount, ix];
        }
 ...
 */
export function checkPoolWithConfigExists(connection, tokenA, tokenB, config, opt) {
    return __awaiter(this, void 0, void 0, function* () {
        const { ammProgram } = createProgram(connection, opt === null || opt === void 0 ? void 0 : opt.programId);
...
export function chunkedFetchMultiplePoolAccount(program, pks, chunkSize = 100) {
    return __awaiter(this, void 0, void 0, function* () {
