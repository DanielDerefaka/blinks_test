...
import type { SwitchboardAccountType } from "./accounts/index.js";
import { CrankAccount, QueueAccount } from "./accounts/index.js";
...
export declare class SwitchboardProgram {
    ...
    private readonly _attestationProgram;
     ...
     */
    constructor(program: Program, attestationProgram: Program, cluster: Cluster | "localnet", mint: NativeMint);
    /**
     ...
     */
    static loadAnchorProgram(cluster: Cluster | "localnet", connection: Connection, payerKeypair?: Keypair, programId?: PublicKey): Promise<Program>;
    /**
     ...
     * ```
     */
    static load: (cluster: Cluster | "localnet", connection: Connection, payerKeypair?: Keypair, programId?: PublicKey, attestationProgramId?: PublicKey) => Promise<SwitchboardProgram>;
    /**
     * Create and initialize a {@linkcode SwitchboardProgram} connection object.
     *
     ...
     * ```
     */
    static fromProvider: (provider: AnchorProvider, programId?: PublicKey, attestationProgramId?: PublicKey) => Promise<SwitchboardProgram>;
    /**
     * Create and initialize a {@linkcode SwitchboardProgram} connection object.
     *
     * @param connection - The Solana connection object used to connect to an RPC node.
     ...
     * ```
     */
    static fromConnection: (connection: Connection, payer?: Keypair, programId?: PublicKey, attestationProgramId?: PublicKey) => Promise<SwitchboardProgram>;
     ...
     */
    get attestationProgramId(): PublicKey;
    /**
     ...
     */
    get attestationCoder(): BorshAccountsCoder;
    /**
     ...
     */
    get attestationAccount(): AccountNamespace;
    /**
     ...
     * @return A unique listener ID that can be used to remove the event listener.
     */
    addAttestationEventListener<EventName extends keyof SwitchboardEvents>(eventName: EventName, callback: (data: SwitchboardEvents[EventName], slot: number, signature: string) => void | Promise<void>): number;
    /**
     * Removes the event listener with the specified listener ID.
     *
     * @param listenerId - The unique ID of the event listener to be removed.
