...
class FunctionAccount extends account_js_1.Account {
    ...
    static async createInstruction(program, payer, params, wallet, options) {
        ...
        const cronSchedule = params.schedule
            ? Buffer.from((0, utils_js_1.parseCronSchedule)(params.schedule), "utf-8")
        ...
        const recentSlot = params.recentSlot
            ...
            : new common_1.BN((await program.connection.getLatestBlockhashAndContext({
        ...
        const instruction = types.functionInit(program, {
            params: {
                ...
                requestsFee: (0, utils_js_1.numToBN)(params.requestsFee),
        ...
        return [
            functionAccount,
            new TransactionObject_js_1.TransactionObject(payer, [
                web3_js_1.ComputeBudgetProgram.setComputeUnitLimit({ units: 250000 }),
                instruction,
            ], [], {
                ...options,
    ...
    async setConfigInstruction(payer, params, options) {
        ...
        const setConfigIxn = types.functionSetConfig(this.program, {
            params: {
                ...
                requestsFee: params.requestsFee ? new common_1.BN(params.requestsFee) : null,
            },
        }, {
