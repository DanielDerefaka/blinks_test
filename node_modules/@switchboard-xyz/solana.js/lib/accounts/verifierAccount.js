 ...
 */
class VerifierAccount extends Account {
     ...
     */
    size = this.program.attestationAccount.verifierAccountData.size;
    /**
    ...
    async rotateInstruction(payer, params, options) {
        ...
        const rotateIxn = types.verifierQuoteRotate(this.program, {
