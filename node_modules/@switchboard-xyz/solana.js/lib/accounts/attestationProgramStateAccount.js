 ...
 */
class AttestationProgramStateAccount extends Account {
    static accountName = "State";
    static size = 1128;
    /**
     * @return account size of the global {@linkcode AttestationProgramStateAccount}.
     */
    size = this.program.attestationAccount.attestationProgramState.size;
    /**
...
export { AttestationProgramStateAccount };
