...
const AggregatorAccountData_js_1 = require("../generated/oracle-program/accounts/AggregatorAccountData.cjs");
const JobAccountData_js_1 = require("../generated/oracle-program/accounts/JobAccountData.cjs");
const LeaseAccountData_js_1 = require("../generated/oracle-program/accounts/LeaseAccountData.cjs");
const PermissionAccountData_js_1 = require("../generated/oracle-program/accounts/PermissionAccountData.cjs");
const ix = __importStar(require("../generated/oracle-program/instructions/index.cjs"));
const index_js_1 = require("../generated/oracle-program/types/index.cjs");
const SwitchboardDecimal_js_1 = require("../generated/oracle-program/types/SwitchboardDecimal.cjs");
const SwitchboardPermission_js_1 = require("../generated/oracle-program/types/SwitchboardPermission.cjs");
const TransactionObject_js_1 = require("../TransactionObject.cjs");
const utils_js_1 = require("../utils.cjs");
const account_js_1 = require("./account.cjs");
const aggregatorHistoryBuffer_js_1 = require("./aggregatorHistoryBuffer.cjs");
const crankAccount_js_1 = require("./crankAccount.cjs");
const jobAccount_js_1 = require("./jobAccount.cjs");
const leaseAccount_js_1 = require("./leaseAccount.cjs");
 ...
 */
class AggregatorAccount extends account_js_1.Account {
    static accountName = "AggregatorAccountData";
    history;
    /**
     * Returns the aggregator's name buffer in a stringified format.
     */
    static getName = (aggregator) => (0, common_1.toUtf8)(aggregator.name);
    /**
     * Returns the aggregator's metadata buffer in a stringified format.
     */
    static getMetadata = (aggregator) => (0, common_1.toUtf8)(aggregator.metadata);
    static size = 3851;
    /**
     * Get the size of an {@linkcode AggregatorAccount} on-chain.
     */
    size = this.program.account.aggregatorAccountData.size;
    decode(data) {
        try {
            return AggregatorAccountData_js_1.AggregatorAccountData.decode(data);
        }
        catch {
    ...
    static default() {
        ...
        AggregatorAccountData_js_1.AggregatorAccountData.discriminator.copy(buffer, 0);
        return AggregatorAccountData_js_1.AggregatorAccountData.decode(buffer);
    }
    /**
    ...
    static createMock(programId, data, options) {
        ...
        const state = new AggregatorAccountData_js_1.AggregatorAccountData(fields);
        const buffer = Buffer.alloc(AggregatorAccount.size, 0);
        AggregatorAccountData_js_1.AggregatorAccountData.discriminator.copy(buffer, 0);
        AggregatorAccountData_js_1.AggregatorAccountData.layout.encode(state, buffer, 8);
        return {
            executable: false,
            owner: programId,
     ...
     */
    async loadData() {
        const data = await AggregatorAccountData_js_1.AggregatorAccountData.fetch(this.program, this.publicKey);
        if (data === null)
            throw new errors.AccountNotFoundError("Aggregator", this.publicKey);
        this.history = aggregatorHistoryBuffer_js_1.AggregatorHistoryBuffer.fromAggregator(this.program, data);
        return data;
    }
    ...
    static async createInstruction(program, payer, params, options) {
        if (params.batchSize > 8) {
            throw new errors.AggregatorConfigError("oracleRequestBatchSize", "must be less than or equal to 8");
        }
        ...
        ixns.push(ix.aggregatorInit(program, {
            params: {
                ...
                startAfter: new common_1.BN(params.startAfter ?? 0),
                varianceThreshold: SwitchboardDecimal_js_1.SwitchboardDecimal.fromBig(new common_1.Big(params.varianceThreshold ?? 0)).borsh,
                forceReportPeriod: new common_1.BN(params.forceReportPeriod ?? 0),
        ...
        const aggregatorInitTxn = new TransactionObject_js_1.TransactionObject(payer, ixns, signers, options);
    ...
    static async create(program, params, options) {
        const [account, transaction] = await AggregatorAccount.createInstruction(program, program.walletPubkey, params, options);
    ...
    async transferQueuePart1Instructions(payer, params) {
        ...
        if (newPermissionAccountInfo === null) {
            const [_newPermissionAccount, permissionInitTxn] = permissionAccount_js_1.PermissionAccount.createInstruction(this.program, payer, {
        ...
        if (newLeaseAccountInfo === null) {
            ...
            const [_newLeaseAccount, leaseInit] = await leaseAccount_js_1.LeaseAccount.createInstructions(this.program, payer, {
    ...
    async transferQueuePart2Instructions(payer, params) {
        ...
        const permissionSet = permissionAccount.setInstruction(payer, {
            ...
            permission: new SwitchboardPermission_js_1.PermitOracleQueueUsage(),
        });
    ...
    async transferQueuePart3Instructions(payer, params) {
        ...
        // set the feeds queue
        const setQueueTxn = new TransactionObject_js_1.TransactionObject(payer, [
            ix.aggregatorSetQueue(this.program, { params: {} }, {
        ...
        return TransactionObject_js_1.TransactionObject.pack(txns);
    }
    /**
     * Transfer the feed to the new {@linkcode QueueAccount} and optionally push it on a crank. Must be signed by the Aggregator authority to approve the transfer.
     *
    ...
    async transferQueueInstructions(payer, params, opts) {
        ...
        txns.push(...part3);
        return [
            TransactionObject_js_1.TransactionObject.pack(txns, opts),
            permissionAccount,
            leaseAccount,
        ];
    }
    ...
    getLeaseAccount(queuePubkey) {
        const [leaseAccount, leaseBump] = leaseAccount_js_1.LeaseAccount.fromSeed(this.program, queuePubkey, this.publicKey);
    ...
    getConfirmedRoundResults(aggregator) {
        return AggregatorAccount.decodeConfirmedRoundResults(aggregator).map((o) => {
            return {
                oracleAccount: new oracleAccount_js_1.OracleAccount(this.program, o.oraclePubkeys),
                value: o.value,
            };
        });
    }
    ...
    async loadCurrentRoundOracles(aggregator) {
        return await Promise.all(AggregatorAccount.decodeCurrentRoundOracles(aggregator).map(async (o) => {
            const oracleAccount = new oracleAccount_js_1.OracleAccount(this.program, o);
            return {
    ...
    async loadJobs(aggregator) {
        ...
        return await Promise.all(jobAccountDatas.map(async (j) => {
            ...
            const jobAccount = new jobAccount_js_1.JobAccount(this.program, j.publicKey);
     ...
     * ```
     */
    static verifyConfig(aggregator, queue, target) {
        ...
        if (endState.minJobResults === 0 || endState.minJobResults > 16) {
            throw new errors.AggregatorConfigError("minJobResults", "must be a value between 1 and 16");
        }
        if (endState.minJobResults > aggregator.jobPubkeysSize) {
            console.warn(`The aggregator's minJobResults (${endState.minJobResults}) is less than the current number of jobs (${aggregator.jobPubkeysSize})`);
        }
    ...
    async setConfigInstruction(payer, params, options) {
        if (!(params.force ?? false)) {
            const aggregator = await this.loadData();
            const queueAccount = new queueAccount_js_1.QueueAccount(this.program, aggregator.queuePubkey);
        ...
        const setConfigIxn = ix.aggregatorSetConfig(this.program, {
            params: {
                name: params.name
                    ? [
                ...
                varianceThreshold: params.varianceThreshold !== undefined &&
                    params.varianceThreshold !== null
                    ? new index_js_1.BorshDecimal(SwitchboardDecimal_js_1.SwitchboardDecimal.fromBig(new common_1.Big(params.varianceThreshold)))
                    : null,
    ...
    setQueueInstruction(payer, params, options) {
        const setQueueIxn = ix.aggregatorSetQueue(this.program, {
            params: {},
        }, {
            aggregator: this.publicKey,
            authority: params.authority ? params.authority.publicKey : payer,
        ...
        return new TransactionObject_js_1.TransactionObject(payer, [setQueueIxn], params.authority ? [params.authority] : [], options);
    }
    ...
    addJobInstruction(payer, params, options) {
        ...
        const addJobIxn = ix.aggregatorAddJob(this.program, { params: { weight: params.weight ?? 1 } }, {
            aggregator: this.publicKey,
            authority: authority,
            job: params.job.publicKey,
        });
        return new TransactionObject_js_1.TransactionObject(payer, [addJobIxn], params.authority ? [params.authority] : [], options);
    }
    ...
    lockInstruction(payer, params, options) {
        return new TransactionObject_js_1.TransactionObject(payer, [
            ix.aggregatorLock(this.program, { params: {} }, {
                aggregator: this.publicKey,
                authority: params.authority ? params.authority.publicKey : payer,
            }),
    ...
    setAuthorityInstruction(payer, params, options) {
        return new TransactionObject_js_1.TransactionObject(payer, [
            ix.aggregatorSetAuthority(this.program, { params: {} }, {
                aggregator: this.publicKey,
                authority: params.authority ? params.authority.publicKey : payer,
    ...
    removeJobInstruction(payer, params, options) {
        const authority = params.authority ? params.authority.publicKey : payer;
        const removeJobIxn = ix.aggregatorRemoveJob(this.program, { params: { jobIdx: params.jobIdx } }, {
            aggregator: this.publicKey,
            authority: authority,
            job: params.job.publicKey,
        });
        return new TransactionObject_js_1.TransactionObject(payer, [removeJobIxn], params.authority ? [params.authority] : [], options);
    }
    ...
    async openRoundInstruction(payer, params, options) {
        ...
        const queueAccount = new queueAccount_js_1.QueueAccount(this.program, aggregatorData.queuePubkey);
        const queue = await queueAccount.loadData();
        ...
        ixns.push(ix.aggregatorOpenRound(this.program, {
            params: {
        ...
        return new TransactionObject_js_1.TransactionObject(payer, ixns, [], options);
    }
    ...
    quoteKeypairFromSeed(seed) {
        const hash = (0, crypto_1.createHash)("sha256");
        hash.update(Buffer.from("EnclaveAccountData"));
        hash.update(seed.toBuffer());
        const kp = web3_js_1.Keypair.fromSeed(hash.digest());
        return kp;
    }
    teeSaveResultInstructionSync(payer, params, options) {
        const [oraclePermissionAccount, oraclePermissionBump] = params.oraclePermission;
        const quote = params.quotePubkey ??
            this.quoteKeypairFromSeed(params.oracles[params.oracleIdx].state.oracleAuthority).publicKey;
        const saveResultIxn = ix.aggregatorTeeSaveResult(this.program, {
            params: {
                // oracleIdx: params.oracleIdx,
                // error: params.error ?? false,
                value: SwitchboardDecimal_js_1.SwitchboardDecimal.fromBig(params.value).borsh,
                jobsChecksum: [...this.produceJobsHash(params.jobs).digest()],
                minResponse: SwitchboardDecimal_js_1.SwitchboardDecimal.fromBig(params.minResponse).borsh,
                maxResponse: SwitchboardDecimal_js_1.SwitchboardDecimal.fromBig(params.maxResponse).borsh,
        ...
        return new TransactionObject_js_1.TransactionObject(payer, [saveResultIxn], [params.authority], options);
    }
    saveResultInstructionSync(payer, params, options) {
        ...
        const saveResultIxn = ix.aggregatorSaveResult(this.program, {
            params: {
                oracleIdx: params.oracleIdx,
                error: params.error ?? false,
                value: SwitchboardDecimal_js_1.SwitchboardDecimal.fromBig(params.value).borsh,
    ...
    async saveResultInstruction(payer, params, options) {
        ...
        const queueAccount = params.queueAccount ??
            new queueAccount_js_1.QueueAccount(this.program, aggregator.queuePubkey);
    ...
    async fetchAccounts(_aggregator, _queueAccount, _queue, commitment = "confirmed") {
        ...
        const queueAccount = _queueAccount ?? new queueAccount_js_1.QueueAccount(this.program, aggregator.queuePubkey);
        ...
        const permission = PermissionAccountData_js_1.PermissionAccountData.decode(permissionAccountInfo.account.data);
        ...
        const lease = LeaseAccountData_js_1.LeaseAccountData.decode(leaseAccountInfo.account.data);
        ...
        accountInfos.map((accountInfo) => {
            ...
            const job = JobAccountData_js_1.JobAccountData.decode(accountInfo.account.data);
    ...
    setResolutionModeInstruction(payer, params, options) {
        return new TransactionObject_js_1.TransactionObject(payer, [
            ix.aggregatorSetResolutionMode(this.program, {
    ...
    async setResolutionMode(params, options) {
        const setResolutionModeTxn = this.setResolutionModeInstruction(this.program.walletPubkey, params, options);
            ...
            ws = this.onChange((aggregator) => {
                ...
                if (aggregator.latestConfirmedRound.roundOpenSlot.gt(currentRoundOpenSlot) &&
                    (aggregator.resolutionMode.kind ===
                        index_js_1.AggregatorResolutionMode.ModeSlidingResolution.kind ||
    ...
    async loadHistory(startTimestamp, endTimestamp) {
        if (!this.history) {
            this.history = new aggregatorHistoryBuffer_js_1.AggregatorHistoryBuffer(this.program, (await this.loadData()).historyBuffer);
        }
    ...
    static async fetchMultiple(program, publicKeys, commitment = "confirmed") {
        ...
        for (const accountInfo of accountInfos) {
            ...
            try {
                ...
                const data = AggregatorAccountData_js_1.AggregatorAccountData.decode(accountInfo.account.data);
    ...
    static calculatePriorityFee(aggregator, timestamp = Math.round(Date.now() / 1000), baseFee = 0 // base compute unit price
        ...
        const currentRoundOpenTimestamp = aggregator.currentRound.roundOpenTimestamp.toNumber();
        const latestConfirmedOpenTimestamp = aggregator.latestConfirmedRound.roundOpenTimestamp.toNumber();
        const lastUpdateTimestamp = latestConfirmedOpenTimestamp === 0
            ? timestamp
        ...
        return (0, utils_js_1.calculatePriorityFee)(timestamp, lastUpdateTimestamp, aggregator.basePriorityFee + baseFee, aggregator.priorityFeeBump, aggregator.priorityFeeBumpPeriod, aggregator.maxPriorityFeeMultiplier);
    }
    ...
    static async fundMultipleUpToInstructions(payer, fundUpTo, aggregators, options) {
        ...
        return TransactionObject_js_1.TransactionObject.pack(txns, options);
    }
    ...
    async closeInstructions(payer, params, opts) {
        ...
        const aggregator = await this.loadData();
        const [queueAccount, queue] = await queueAccount_js_1.QueueAccount.load(this.program, aggregator.queuePubkey);
        ...
        let dataBuffer = null;
        if (crankPubkey !== null) {
            const [crankAccount, crank] = await crankAccount_js_1.CrankAccount.load(this.program, crankPubkey);
        ...
        const closeTxn = tokenWalletInit
            ...
            : new TransactionObject_js_1.TransactionObject(payer, [closeIxn], params?.authority ? [params.authority] : []);
        // add txn options
        return new TransactionObject_js_1.TransactionObject(closeTxn.payer, closeTxn.ixns, closeTxn.signers, opts);
    }
