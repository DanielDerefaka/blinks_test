...
class LeaseAccount extends Account {
    ...
    async extendInstruction(payer, params, options) {
        ...
        return new TransactionObject(payer, [leaseExtend], params.funderAuthority ? [params.funderAuthority] : [], options);
    }
    ...
    async withdrawInstruction(payer, params, options) {
        ...
        if (params.unwrap) {
            ...
            const txn = new TransactionObject(payer, ixns, [ephemeralWallet], options);
            return txn;
        }
