...
import { AggregatorResolutionMode, BorshDecimal, } from "../generated/oracle-program/types/index.js";
...
class AggregatorAccount extends Account {
     ...
     */
    async loadData() {
        const data = await AggregatorAccountData.fetch(this.program, this.publicKey);
        if (data === null)
    ...
    static async createInstruction(program, payer, params, options) {
        ...
        ixns.push(ix.aggregatorInit(program, {
            params: {
                ...
                varianceThreshold: SwitchboardDecimal.fromBig(new Big(params.varianceThreshold ?? 0)).borsh,
        ...
        const aggregatorInitTxn = new TransactionObject(payer, ixns, signers, options);
        ...
        const setConfigIxn = ix.aggregatorSetConfig(this.program, {
            params: {
                ...
                varianceThreshold: params.varianceThreshold !== undefined &&
                    ...
                    ? new BorshDecimal(SwitchboardDecimal.fromBig(new Big(params.varianceThreshold)))
                    : null,
    ...
    teeSaveResultInstructionSync(payer, params, options) {
        ...
        return new TransactionObject(payer, [saveResultIxn], [params.authority], options);
    }
    ...
    async fetchAccounts(_aggregator, _queueAccount, _queue, commitment = "confirmed") {
        ...
        const permission = PermissionAccountData.decode(permissionAccountInfo.account.data);
    ...
    static calculatePriorityFee(aggregator, timestamp = Math.round(Date.now() / 1000), baseFee = 0 // base compute unit price
        ...
        return calculatePriorityFee(timestamp, lastUpdateTimestamp, aggregator.basePriorityFee + baseFee, aggregator.priorityFeeBump, aggregator.priorityFeeBumpPeriod, aggregator.maxPriorityFeeMultiplier);
    }
