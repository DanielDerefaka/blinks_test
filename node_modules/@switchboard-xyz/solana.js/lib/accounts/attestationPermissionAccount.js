 ...
 */
class AttestationPermissionAccount extends Account {
     ...
     */
    size = this.program.attestationAccount.attestationPermissionAccountData.size;
    /**
...
export { AttestationPermissionAccount };
