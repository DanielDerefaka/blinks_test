...
exports.oracleTeeHeartbeat = exports.layout = void 0;
...
function oracleTeeHeartbeat(program, args, accounts, programId = program.programId) {
    const keys = [
...
exports.oracleTeeHeartbeat = oracleTeeHeartbeat;
