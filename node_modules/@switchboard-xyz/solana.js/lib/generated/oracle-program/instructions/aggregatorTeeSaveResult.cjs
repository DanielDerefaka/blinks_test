...
exports.aggregatorTeeSaveResult = exports.layout = void 0;
...
function aggregatorTeeSaveResult(program, args, accounts, programId = program.programId) {
    const keys = [
...
exports.aggregatorTeeSaveResult = aggregatorTeeSaveResult;
