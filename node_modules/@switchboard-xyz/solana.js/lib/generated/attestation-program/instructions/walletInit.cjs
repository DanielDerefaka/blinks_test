...
exports.walletInit = exports.layout = void 0;
...
exports.layout = borsh.struct([types.WalletInitParams.layout("params")]);
function walletInit(program, args, accounts, programId = program.attestationProgramId) {
    const keys = [
