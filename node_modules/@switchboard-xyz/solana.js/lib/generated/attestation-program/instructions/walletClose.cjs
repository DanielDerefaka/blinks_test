...
exports.walletClose = exports.layout = void 0;
...
exports.layout = borsh.struct([types.WalletCloseParams.layout("params")]);
function walletClose(program, args, accounts, programId = program.attestationProgramId) {
    const keys = [
...
exports.walletClose = walletClose;
