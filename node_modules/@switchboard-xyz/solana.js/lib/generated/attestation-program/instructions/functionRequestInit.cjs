...
exports.functionRequestInit = exports.layout = void 0;
...
function functionRequestInit(program, args, accounts, programId = program.attestationProgramId) {
    const keys = [
...
exports.functionRequestInit = functionRequestInit;
