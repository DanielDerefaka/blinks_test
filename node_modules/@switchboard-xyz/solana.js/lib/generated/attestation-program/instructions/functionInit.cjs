...
exports.functionInit = exports.layout = void 0;
...
exports.layout = borsh.struct([types.FunctionInitParams.layout("params")]);
function functionInit(program, args, accounts, programId = program.attestationProgramId) {
    const keys = [
...
exports.functionInit = functionInit;
