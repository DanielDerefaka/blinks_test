...
class FunctionSetConfigParams {
    ...
    static fromJSON(obj) {
        return new FunctionSetConfigParams({
            ...
            requestsDisabled: obj.requestsDisabled,
            requestsRequireAuthorization: obj.requestsRequireAuthorization,
            requestsFee: (obj.requestsFee && new common_1.BN(obj.requestsFee)) || null,
        });
    }
    toEncodable() {
...
exports.FunctionSetConfigParams = FunctionSetConfigParams;
