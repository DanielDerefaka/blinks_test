...
export { RequestPending };
class RequestCancelled {
    static discriminator = 2;
    static kind = "RequestCancelled";
    discriminator = 2;
...
export { RequestFailure };
class RequestExpired {
    static discriminator = 4;
    static kind = "RequestExpired";
    discriminator = 4;
    kind = "RequestExpired";
    toJSON() {
        return {
