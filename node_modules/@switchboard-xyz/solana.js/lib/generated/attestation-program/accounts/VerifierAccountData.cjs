...
exports.VerifierAccountData = void 0;
...
class VerifierAccountData {
    ...
    static fromJSON(obj) {
        return new VerifierAccountData({
            ...
            rewardEscrow: new web3_js_1.PublicKey(obj.rewardEscrow),
            stakeWallet: new web3_js_1.PublicKey(obj.stakeWallet),
            ebuf: obj.ebuf,
        });
    }
}
exports.VerifierAccountData = VerifierAccountData;
