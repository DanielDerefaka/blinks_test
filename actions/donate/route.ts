import {
  ...
  const DONATION_DESTINATION_WALLET =
    'CxhsuRCRTT4zuUfKCCLqReiqpbhwRTPubWMaW4DxwCGQ';
  const DONATION_AMOUNT_SOL_OPTIONS = [0.01, 0.05, 1];
  ...
  > {
    const icon =
      'https://utfs.io/f/290c971a-b000-4c63-adef-a69bc7e1bfab-bvd7b8.JPG';
    const title = 'Donate to Dx';
    const description =
      'Solana Developer | Support my team with a donation.';
